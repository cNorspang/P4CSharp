...
void DEFINED_LOCATION_DebugMenu(){
    ...
    int USER_CHOICE_INPUT_47dqF536 = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_47dqF536 == 1){

DEFINED_LOCATION_The_local_pub();
  }

  if (USER_CHOICE_INPUT_47dqF536 == 2){
  ...
  if (USER_CHOICE_INPUT_47dqF536 == 3){
  ...
  if (USER_CHOICE_INPUT_47dqF536 == 4){
  ...
  if (USER_CHOICE_INPUT_47dqF536 == 5){
  ...
  if (USER_CHOICE_INPUT_47dqF536 == 6){
    ...
    int USER_CHOICE_INPUT_rtk7TDB5 = COMPILER_TOOL_GET_INPUT(9);

  if (USER_CHOICE_INPUT_rtk7TDB5 == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_rtk7TDB5 == 2){

DEFINED_LOCATION_Street();
  }

  if (USER_CHOICE_INPUT_rtk7TDB5 == 3){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_rtk7TDB5 == 4){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_rtk7TDB5 == 5){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_rtk7TDB5 == 6){

DEFINED_LOCATION_FightTheDragon();
  }

  if (USER_CHOICE_INPUT_rtk7TDB5 == 7){

DEFINED_LOCATION_House();
  }

  if (USER_CHOICE_INPUT_rtk7TDB5 == 8){

DEFINED_LOCATION_TheEnd();
  }

  if (USER_CHOICE_INPUT_rtk7TDB5 == 9){
...
void DEFINED_LOCATION_The_local_pub(){
    ...
    int USER_CHOICE_INPUT_fHtwajQ = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_fHtwajQ == 1){
    ...
    int USER_CHOICE_INPUT_kLfWPgUp = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_kLfWPgUp == 1){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_kLfWPgUp == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_fHtwajQ == 2){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_fHtwajQ == 3){
...
void DEFINED_LOCATION_Garden(){
  if (PLAYER_STRUCT.VisitedGarden == false) {
    ...
    int USER_CHOICE_INPUT_5YKNNTve = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_5YKNNTve == 1){
    PLAYER_STRUCT.Gold+=PLAYER_STRUCT.money_on_people_in_Garden;
  }

  if (USER_CHOICE_INPUT_5YKNNTve == 2){
...
DEFINED_LOCATION_Bar();
  ...
  if (PLAYER_STRUCT.VisitedGarden == true) {
    ...
    int USER_CHOICE_INPUT_jAK3F5LI = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_jAK3F5LI == 1){
  if (PLAYER_STRUCT.Gold >= 50 && PLAYER_STRUCT.Boost_of_internal_power_for_one_attack == true) {
    ...
    int USER_CHOICE_INPUT_3T5kvCWU = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_3T5kvCWU == 1){
  ...
  if (USER_CHOICE_INPUT_3T5kvCWU == 2){
  ...
  if (USER_CHOICE_INPUT_jAK3F5LI == 2){
...
void DEFINED_LOCATION_Bar(){
  if (PLAYER_STRUCT.VisitedBar == false) {
    ...
    int USER_CHOICE_INPUT_VBVNfxCq = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_VBVNfxCq == 1){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (USER_CHOICE_INPUT_VBVNfxCq == 2){
  ...
  if (USER_CHOICE_INPUT_VBVNfxCq == 3){
    ...
    int USER_CHOICE_INPUT_TUpZNn7W = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_TUpZNn7W == 1){
    PLAYER_STRUCT.Gold-=1;
  ...
  if (USER_CHOICE_INPUT_TUpZNn7W == 2){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (PLAYER_STRUCT.CanLeaveBar) printf("\n6. ... (leave)"); 
    ...
    int USER_CHOICE_INPUT_wJgx0xc7 = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_wJgx0xc7 == 1){
  ...
  if (USER_CHOICE_INPUT_wJgx0xc7 == 2){
  ...
  if (USER_CHOICE_INPUT_wJgx0xc7 == 3){
...
DEFINED_LOCATION_GamblingTable();
  ...
  if (USER_CHOICE_INPUT_wJgx0xc7 == 4){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_wJgx0xc7 == 5){
...
DEFINED_LOCATION_Street();
 ...
 if (PLAYER_STRUCT.CanLeaveBar){
  ...
  if (USER_CHOICE_INPUT_wJgx0xc7 == 6){
...
DEFINED_LOCATION_Street();
 ...
 } else if (USER_CHOICE_INPUT_wJgx0xc7 == 6) { USER_CHOICE_INPUT_wJgx0xc7 = 7; } 
...
void DEFINED_LOCATION_GamblingTable(){
  ...
  if (PLAYER_STRUCT.Gold >= 1000) printf("\n6. Bet 1000"); 
    ...
    int USER_CHOICE_INPUT_pkoaPf6X = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_pkoaPf6X == 1){
...
DEFINED_LOCATION_Bar();
 ...
 if (PLAYER_STRUCT.Gold >= 5){
  ...
  if (USER_CHOICE_INPUT_pkoaPf6X == 2){
    playerBet=5;
  }

 } else if (USER_CHOICE_INPUT_pkoaPf6X == 2) { USER_CHOICE_INPUT_pkoaPf6X = 3; } 

 if (PLAYER_STRUCT.Gold >= 10){

  if (USER_CHOICE_INPUT_pkoaPf6X == 3){
    playerBet=10;
  }

 } else if (USER_CHOICE_INPUT_pkoaPf6X == 3) { USER_CHOICE_INPUT_pkoaPf6X = 4; } 

 if (PLAYER_STRUCT.Gold >= 20){

  if (USER_CHOICE_INPUT_pkoaPf6X == 4){
    playerBet=20;
  }

 } else if (USER_CHOICE_INPUT_pkoaPf6X == 4) { USER_CHOICE_INPUT_pkoaPf6X = 5; } 

 if (PLAYER_STRUCT.Gold >= 50){

  if (USER_CHOICE_INPUT_pkoaPf6X == 5){
    playerBet=50;
  }

 } else if (USER_CHOICE_INPUT_pkoaPf6X == 5) { USER_CHOICE_INPUT_pkoaPf6X = 6; } 

 if (PLAYER_STRUCT.Gold >= 1000){

  if (USER_CHOICE_INPUT_pkoaPf6X == 6){
    playerBet=1000;
  }

 } else if (USER_CHOICE_INPUT_pkoaPf6X == 6) { USER_CHOICE_INPUT_pkoaPf6X = 7; } 
  ...
  if (playerRoll == 20) {
    ...
    int USER_CHOICE_INPUT_vEVEqEaC = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_vEVEqEaC == 1){
  ...
  if (USER_CHOICE_INPUT_vEVEqEaC == 2){
  if (playerRoll < dealerRoll) {
    PLAYER_STRUCT.Gold+=playerBet;
  }
  else {
  ...
  if (USER_CHOICE_INPUT_vEVEqEaC == 3){
  if (playerRoll == dealerRoll) {
...
void DEFINED_LOCATION_Street(){
    ...
    int USER_CHOICE_INPUT_rRbUzOhN = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_rRbUzOhN == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_rRbUzOhN == 2){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_rRbUzOhN == 3){

DEFINED_LOCATION_Shop();
  }

  if (USER_CHOICE_INPUT_rRbUzOhN == 4){
...
void DEFINED_LOCATION_Shop(){
  if (PLAYER_STRUCT.VisitedShop == false) {
    ...
    int USER_CHOICE_INPUT_b1jeeta = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_b1jeeta == 1){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_b1jeeta == 2){
  if (PLAYER_STRUCT.Gold >= 10) {
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_b1jeeta == 3){
...
void DEFINED_LOCATION_Forrest(){
  if (PLAYER_STRUCT.VisitedForrest == false) {
    ...
    int USER_CHOICE_INPUT_SJMLNsZr = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_SJMLNsZr == 1){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_SJMLNsZr == 2){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_SJMLNsZr == 3){
...
void DEFINED_LOCATION_Field(){
    ...
    int USER_CHOICE_INPUT_Dd0SjGrj = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_Dd0SjGrj == 1){
    ...
    int USER_CHOICE_INPUT_AdnPJTqB = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_AdnPJTqB == 1){
  ...
  if (USER_CHOICE_INPUT_AdnPJTqB == 2){
  ...
  if (bad == true) {
    ...
    int USER_CHOICE_INPUT_ESvbgk5O = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_ESvbgk5O == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_ESvbgk5O == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_ESvbgk5O == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_Dd0SjGrj == 2){
    ...
    int USER_CHOICE_INPUT_Al9AkpnH = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_Al9AkpnH == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_Al9AkpnH == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_Al9AkpnH == 3){
...
DEFINED_LOCATION_WitchFight();
    ...
    int USER_CHOICE_INPUT_cax7dYWg = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_cax7dYWg == 1){
    ...
    int USER_CHOICE_INPUT_6uKrvYTw = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_6uKrvYTw == 1){
...
DEFINED_LOCATION_Basement();
  ...
  if (USER_CHOICE_INPUT_6uKrvYTw == 2){
...
DEFINED_LOCATION_Field();
  ...
  if (USER_CHOICE_INPUT_cax7dYWg == 2){
...
void DEFINED_LOCATION_WitchFight(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_x5QTOnWD = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_x5QTOnWD == 1){
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_x5QTOnWD == 2){
 ...
 } else if (USER_CHOICE_INPUT_x5QTOnWD == 2) { USER_CHOICE_INPUT_x5QTOnWD = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_x5QTOnWD == 3){
 ...
 } else if (USER_CHOICE_INPUT_x5QTOnWD == 3) { USER_CHOICE_INPUT_x5QTOnWD = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_x5QTOnWD == 4){
 ...
 } else if (USER_CHOICE_INPUT_x5QTOnWD == 4) { USER_CHOICE_INPUT_x5QTOnWD = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_x5QTOnWD == 5){
 ...
 } else if (USER_CHOICE_INPUT_x5QTOnWD == 5) { USER_CHOICE_INPUT_x5QTOnWD = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_x5QTOnWD == 6){
 ...
 } else if (USER_CHOICE_INPUT_x5QTOnWD == 6) { USER_CHOICE_INPUT_x5QTOnWD = 7; } 
...
DEFINED_LOCATION_House();
  ...
  if (witch_HP < 50 && Random_Int_Num(1, 2) == 1) {
    ...
    int USER_CHOICE_INPUT_QtZfSO9 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_QtZfSO9 == 1){
  ...
  if (USER_CHOICE_INPUT_QtZfSO9 == 2){
  ...
  if (Random_Int_Num(1, 15) == 1) printf("\n5. Smack that booty"); 
    ...
    int USER_CHOICE_INPUT_ZNwN0Dqm = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_ZNwN0Dqm == 1){
 ...
 if (Random_Int_Num(1, 3) == 1){
  ...
  if (USER_CHOICE_INPUT_ZNwN0Dqm == 2){
 ...
 } else if (USER_CHOICE_INPUT_ZNwN0Dqm == 2) { USER_CHOICE_INPUT_ZNwN0Dqm = 3; } 

 if (Random_Int_Num(1, 3) == 1){

  if (USER_CHOICE_INPUT_ZNwN0Dqm == 3){
 ...
 } else if (USER_CHOICE_INPUT_ZNwN0Dqm == 3) { USER_CHOICE_INPUT_ZNwN0Dqm = 4; } 

 if (Random_Int_Num(1, 4) == 1){

  if (USER_CHOICE_INPUT_ZNwN0Dqm == 4){
 ...
 } else if (USER_CHOICE_INPUT_ZNwN0Dqm == 4) { USER_CHOICE_INPUT_ZNwN0Dqm = 5; } 

 if (Random_Int_Num(1, 15) == 1){

  if (USER_CHOICE_INPUT_ZNwN0Dqm == 5){
 ...
 } else if (USER_CHOICE_INPUT_ZNwN0Dqm == 5) { USER_CHOICE_INPUT_ZNwN0Dqm = 6; } 
...
void DEFINED_LOCATION_Old_Castle(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_mYYwysYB = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_mYYwysYB == 1){
  ...
  if (USER_CHOICE_INPUT_mYYwysYB == 2){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_JWj5Dg7X = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_JWj5Dg7X == 1){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_JWj5Dg7X == 2){
  ...
  if (USER_CHOICE_INPUT_JWj5Dg7X == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_JWj5Dg7X == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_mYYwysYB == 3){
    ...
    int USER_CHOICE_INPUT_r9p7YWB = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_r9p7YWB == 1){
    ...
    int USER_CHOICE_INPUT_PmS7DS4O = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_PmS7DS4O == 1){
...
DEFINED_LOCATION_FightTheDragon();
  ...
  if (USER_CHOICE_INPUT_PmS7DS4O == 2){
  ...
  if (USER_CHOICE_INPUT_r9p7YWB == 2){
...
void DEFINED_LOCATION_Bed_Room(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_NSzIW9Gw = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_NSzIW9Gw == 1){
  ...
  if (USER_CHOICE_INPUT_NSzIW9Gw == 2){
    ...
    int USER_CHOICE_INPUT_gzYBYFL1 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_gzYBYFL1 == 1){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_dxyFfMaH = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_dxyFfMaH == 1){
  ...
  if (USER_CHOICE_INPUT_dxyFfMaH == 2){

DEFINED_LOCATION_Dining_Room();
  }

  if (USER_CHOICE_INPUT_dxyFfMaH == 3){
...
DEFINED_LOCATION_Old_Castle();
  ...
  if (USER_CHOICE_INPUT_gzYBYFL1 == 2){
  ...
  if (USER_CHOICE_INPUT_NSzIW9Gw == 3){
  ...
  if (USER_CHOICE_INPUT_NSzIW9Gw == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_NSzIW9Gw == 5){
...
void DEFINED_LOCATION_FightTheDragon(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_WyHg8Yje = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_WyHg8Yje == 1){
    roll=Random_Int_Num(3, 8);
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_WyHg8Yje == 2){
    roll=Random_Int_Num(PLAYER_STRUCT.regular_sword_damage-3, PLAYER_STRUCT.regular_sword_damage+3);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_WyHg8Yje == 2) { USER_CHOICE_INPUT_WyHg8Yje = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_WyHg8Yje == 3){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.potion_health;
 ...
 } else if (USER_CHOICE_INPUT_WyHg8Yje == 3) { USER_CHOICE_INPUT_WyHg8Yje = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_WyHg8Yje == 4){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.bandage_health;
 ...
 } else if (USER_CHOICE_INPUT_WyHg8Yje == 4) { USER_CHOICE_INPUT_WyHg8Yje = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_WyHg8Yje == 5){
 ...
 } else if (USER_CHOICE_INPUT_WyHg8Yje == 5) { USER_CHOICE_INPUT_WyHg8Yje = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_WyHg8Yje == 6){
    roll=Random_Int_Num(PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE-13, PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE+13);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_WyHg8Yje == 6) { USER_CHOICE_INPUT_WyHg8Yje = 7; } 
...
DEFINED_LOCATION_TheEnd();
  ...
  if (The_dragon_of_smaguron_health < 400 && Random_Int_Num(1, 3) == 3) {
    ...
    int USER_CHOICE_INPUT_lR1mZjTY = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_lR1mZjTY == 1){
  ...
  if (USER_CHOICE_INPUT_lR1mZjTY == 2){
    PLAYER_STRUCT.Health_point+=4;
  }
    ...
    int USER_CHOICE_INPUT_CGaIyjZJ = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_CGaIyjZJ == 1){
  ...
  if (USER_CHOICE_INPUT_CGaIyjZJ == 2){
  ...
  if (USER_CHOICE_INPUT_CGaIyjZJ == 3){
