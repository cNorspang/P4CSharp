...
void DEFINED_LOCATION_DebugMenu(){
    ...
    int USER_CHOICE_INPUT_sMXv4QOS = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_sMXv4QOS == 1){

DEFINED_LOCATION_The_local_pub();
  }

  if (USER_CHOICE_INPUT_sMXv4QOS == 2){
  ...
  if (USER_CHOICE_INPUT_sMXv4QOS == 3){
  ...
  if (USER_CHOICE_INPUT_sMXv4QOS == 4){
  ...
  if (USER_CHOICE_INPUT_sMXv4QOS == 5){
  ...
  if (USER_CHOICE_INPUT_sMXv4QOS == 6){
    ...
    int USER_CHOICE_INPUT_QE1tB9N = COMPILER_TOOL_GET_INPUT(9);

  if (USER_CHOICE_INPUT_QE1tB9N == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_QE1tB9N == 2){

DEFINED_LOCATION_Street();
  }

  if (USER_CHOICE_INPUT_QE1tB9N == 3){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_QE1tB9N == 4){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_QE1tB9N == 5){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_QE1tB9N == 6){

DEFINED_LOCATION_FightTheDragon();
  }

  if (USER_CHOICE_INPUT_QE1tB9N == 7){

DEFINED_LOCATION_House();
  }

  if (USER_CHOICE_INPUT_QE1tB9N == 8){

DEFINED_LOCATION_TheEnd();
  }

  if (USER_CHOICE_INPUT_QE1tB9N == 9){
...
void DEFINED_LOCATION_The_local_pub(){
    ...
    int USER_CHOICE_INPUT_rRgFTg4v = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_rRgFTg4v == 1){
    ...
    int USER_CHOICE_INPUT_4LTl8I6n = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_4LTl8I6n == 1){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_4LTl8I6n == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_rRgFTg4v == 2){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_rRgFTg4v == 3){
...
void DEFINED_LOCATION_Garden(){
  if (PLAYER_STRUCT.VisitedGarden == false) {
    ...
    int USER_CHOICE_INPUT_TJmKqrIT = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_TJmKqrIT == 1){
    PLAYER_STRUCT.Gold+=PLAYER_STRUCT.money_on_people_in_Garden;
  }

  if (USER_CHOICE_INPUT_TJmKqrIT == 2){
...
DEFINED_LOCATION_Bar();
  ...
  if (PLAYER_STRUCT.VisitedGarden == true) {
    ...
    int USER_CHOICE_INPUT_6OHuMqXK = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_6OHuMqXK == 1){
  if (PLAYER_STRUCT.Gold >= 50 && PLAYER_STRUCT.Boost_of_internal_power_for_one_attack == true) {
    ...
    int USER_CHOICE_INPUT_Y2iQCTKC = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_Y2iQCTKC == 1){
  ...
  if (USER_CHOICE_INPUT_Y2iQCTKC == 2){
  ...
  if (USER_CHOICE_INPUT_6OHuMqXK == 2){
...
void DEFINED_LOCATION_Bar(){
  if (PLAYER_STRUCT.VisitedBar == false) {
    ...
    int USER_CHOICE_INPUT_jakI3wsh = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_jakI3wsh == 1){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (USER_CHOICE_INPUT_jakI3wsh == 2){
  ...
  if (USER_CHOICE_INPUT_jakI3wsh == 3){
    ...
    int USER_CHOICE_INPUT_QYf95xf3 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_QYf95xf3 == 1){
    PLAYER_STRUCT.Gold-=1;
  ...
  if (USER_CHOICE_INPUT_QYf95xf3 == 2){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (PLAYER_STRUCT.CanLeaveBar) printf("\n6. ... (leave)"); 
    ...
    int USER_CHOICE_INPUT_GWM9xgHd = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_GWM9xgHd == 1){
  ...
  if (USER_CHOICE_INPUT_GWM9xgHd == 2){
  ...
  if (USER_CHOICE_INPUT_GWM9xgHd == 3){
...
DEFINED_LOCATION_GamblingTable();
  ...
  if (USER_CHOICE_INPUT_GWM9xgHd == 4){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_GWM9xgHd == 5){
...
DEFINED_LOCATION_Street();
 ...
 if (PLAYER_STRUCT.CanLeaveBar){
  ...
  if (USER_CHOICE_INPUT_GWM9xgHd == 6){
...
DEFINED_LOCATION_Street();
 ...
 } else if (USER_CHOICE_INPUT_GWM9xgHd == 6) { USER_CHOICE_INPUT_GWM9xgHd = 7; } 
...
void DEFINED_LOCATION_GamblingTable(){
  ...
  if (PLAYER_STRUCT.Gold >= 1000) printf("\n6. Bet 1000"); 
    ...
    int USER_CHOICE_INPUT_KA7ENQlF = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_KA7ENQlF == 1){
...
DEFINED_LOCATION_Bar();
 ...
 if (PLAYER_STRUCT.Gold >= 5){
  ...
  if (USER_CHOICE_INPUT_KA7ENQlF == 2){
    playerBet=5;
  }

 } else if (USER_CHOICE_INPUT_KA7ENQlF == 2) { USER_CHOICE_INPUT_KA7ENQlF = 3; } 

 if (PLAYER_STRUCT.Gold >= 10){

  if (USER_CHOICE_INPUT_KA7ENQlF == 3){
    playerBet=10;
  }

 } else if (USER_CHOICE_INPUT_KA7ENQlF == 3) { USER_CHOICE_INPUT_KA7ENQlF = 4; } 

 if (PLAYER_STRUCT.Gold >= 20){

  if (USER_CHOICE_INPUT_KA7ENQlF == 4){
    playerBet=20;
  }

 } else if (USER_CHOICE_INPUT_KA7ENQlF == 4) { USER_CHOICE_INPUT_KA7ENQlF = 5; } 

 if (PLAYER_STRUCT.Gold >= 50){

  if (USER_CHOICE_INPUT_KA7ENQlF == 5){
    playerBet=50;
  }

 } else if (USER_CHOICE_INPUT_KA7ENQlF == 5) { USER_CHOICE_INPUT_KA7ENQlF = 6; } 

 if (PLAYER_STRUCT.Gold >= 1000){

  if (USER_CHOICE_INPUT_KA7ENQlF == 6){
    playerBet=1000;
  }

 } else if (USER_CHOICE_INPUT_KA7ENQlF == 6) { USER_CHOICE_INPUT_KA7ENQlF = 7; } 
  ...
  if (playerRoll == 20) {
    ...
    int USER_CHOICE_INPUT_StmgP2rS = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_StmgP2rS == 1){
  ...
  if (USER_CHOICE_INPUT_StmgP2rS == 2){
  if (playerRoll < dealerRoll) {
    PLAYER_STRUCT.Gold+=playerBet;
  }
  else {
  ...
  if (USER_CHOICE_INPUT_StmgP2rS == 3){
  if (playerRoll == dealerRoll) {
...
void DEFINED_LOCATION_Street(){
    ...
    int USER_CHOICE_INPUT_r5e18ph = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_r5e18ph == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_r5e18ph == 2){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_r5e18ph == 3){

DEFINED_LOCATION_Shop();
  }

  if (USER_CHOICE_INPUT_r5e18ph == 4){
...
void DEFINED_LOCATION_Shop(){
  if (PLAYER_STRUCT.VisitedShop == false) {
    ...
    int USER_CHOICE_INPUT_atQb4fRZ = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_atQb4fRZ == 1){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_atQb4fRZ == 2){
  if (PLAYER_STRUCT.Gold >= 10) {
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_atQb4fRZ == 3){
...
void DEFINED_LOCATION_Forrest(){
  if (PLAYER_STRUCT.VisitedForrest == false) {
    ...
    int USER_CHOICE_INPUT_aiY17t2P = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_aiY17t2P == 1){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_aiY17t2P == 2){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_aiY17t2P == 3){
...
void DEFINED_LOCATION_Field(){
    ...
    int USER_CHOICE_INPUT_XCgP1t = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_XCgP1t == 1){
    ...
    int USER_CHOICE_INPUT_AwVDbhuZ = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_AwVDbhuZ == 1){
  ...
  if (USER_CHOICE_INPUT_AwVDbhuZ == 2){
  ...
  if (bad == true) {
    ...
    int USER_CHOICE_INPUT_zl5tEcFD = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_zl5tEcFD == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_zl5tEcFD == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_zl5tEcFD == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_XCgP1t == 2){
    ...
    int USER_CHOICE_INPUT_gTdyRbqA = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_gTdyRbqA == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_gTdyRbqA == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_gTdyRbqA == 3){
...
DEFINED_LOCATION_WitchFight();
    ...
    int USER_CHOICE_INPUT_6859o5e6 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_6859o5e6 == 1){
    ...
    int USER_CHOICE_INPUT_cTEV7lNs = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_cTEV7lNs == 1){
...
DEFINED_LOCATION_Basement();
  ...
  if (USER_CHOICE_INPUT_cTEV7lNs == 2){
...
DEFINED_LOCATION_Field();
  ...
  if (USER_CHOICE_INPUT_6859o5e6 == 2){
...
void DEFINED_LOCATION_WitchFight(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_pglmsJjQ = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_pglmsJjQ == 1){
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_pglmsJjQ == 2){
 ...
 } else if (USER_CHOICE_INPUT_pglmsJjQ == 2) { USER_CHOICE_INPUT_pglmsJjQ = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_pglmsJjQ == 3){
 ...
 } else if (USER_CHOICE_INPUT_pglmsJjQ == 3) { USER_CHOICE_INPUT_pglmsJjQ = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_pglmsJjQ == 4){
 ...
 } else if (USER_CHOICE_INPUT_pglmsJjQ == 4) { USER_CHOICE_INPUT_pglmsJjQ = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_pglmsJjQ == 5){
 ...
 } else if (USER_CHOICE_INPUT_pglmsJjQ == 5) { USER_CHOICE_INPUT_pglmsJjQ = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_pglmsJjQ == 6){
 ...
 } else if (USER_CHOICE_INPUT_pglmsJjQ == 6) { USER_CHOICE_INPUT_pglmsJjQ = 7; } 
...
DEFINED_LOCATION_House();
  ...
  if (witch_HP < 50 && Random_Int_Num(1, 2) == 1) {
    ...
    int USER_CHOICE_INPUT_GwPMMgH = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_GwPMMgH == 1){
  ...
  if (USER_CHOICE_INPUT_GwPMMgH == 2){
  ...
  if (Random_Int_Num(1, 15) == 1) printf("\n5. Smack that booty"); 
    ...
    int USER_CHOICE_INPUT_XhPSPVRT = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_XhPSPVRT == 1){
 ...
 if (Random_Int_Num(1, 3) == 1){
  ...
  if (USER_CHOICE_INPUT_XhPSPVRT == 2){
 ...
 } else if (USER_CHOICE_INPUT_XhPSPVRT == 2) { USER_CHOICE_INPUT_XhPSPVRT = 3; } 

 if (Random_Int_Num(1, 3) == 1){

  if (USER_CHOICE_INPUT_XhPSPVRT == 3){
 ...
 } else if (USER_CHOICE_INPUT_XhPSPVRT == 3) { USER_CHOICE_INPUT_XhPSPVRT = 4; } 

 if (Random_Int_Num(1, 4) == 1){

  if (USER_CHOICE_INPUT_XhPSPVRT == 4){
 ...
 } else if (USER_CHOICE_INPUT_XhPSPVRT == 4) { USER_CHOICE_INPUT_XhPSPVRT = 5; } 

 if (Random_Int_Num(1, 15) == 1){

  if (USER_CHOICE_INPUT_XhPSPVRT == 5){
 ...
 } else if (USER_CHOICE_INPUT_XhPSPVRT == 5) { USER_CHOICE_INPUT_XhPSPVRT = 6; } 
...
void DEFINED_LOCATION_Old_Castle(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_8Zqu7WS = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_8Zqu7WS == 1){
  ...
  if (USER_CHOICE_INPUT_8Zqu7WS == 2){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_qTjDoNWY = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_qTjDoNWY == 1){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_qTjDoNWY == 2){
  ...
  if (USER_CHOICE_INPUT_qTjDoNWY == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_qTjDoNWY == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_8Zqu7WS == 3){
    ...
    int USER_CHOICE_INPUT_rouiIuIc = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_rouiIuIc == 1){
    ...
    int USER_CHOICE_INPUT_8SQ5UM = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_8SQ5UM == 1){
...
DEFINED_LOCATION_FightTheDragon();
  ...
  if (USER_CHOICE_INPUT_rouiIuIc == 2){
...
void DEFINED_LOCATION_Bed_Room(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_wAWWp4np = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_wAWWp4np == 1){
  ...
  if (USER_CHOICE_INPUT_wAWWp4np == 2){
    ...
    int USER_CHOICE_INPUT_KpeMr4ns = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_KpeMr4ns == 1){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_dn0e9t75 = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_dn0e9t75 == 1){
  ...
  if (USER_CHOICE_INPUT_dn0e9t75 == 2){

DEFINED_LOCATION_Dining_Room();
  }

  if (USER_CHOICE_INPUT_dn0e9t75 == 3){
...
DEFINED_LOCATION_Old_Castle();
  ...
  if (USER_CHOICE_INPUT_KpeMr4ns == 2){
  ...
  if (USER_CHOICE_INPUT_wAWWp4np == 3){
  ...
  if (USER_CHOICE_INPUT_wAWWp4np == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_wAWWp4np == 5){
...
void DEFINED_LOCATION_FightTheDragon(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_OzQjTjKX = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_OzQjTjKX == 1){
    roll=Random_Int_Num(3, 8);
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_OzQjTjKX == 2){
    roll=Random_Int_Num(PLAYER_STRUCT.regular_sword_damage-3, PLAYER_STRUCT.regular_sword_damage+3);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_OzQjTjKX == 2) { USER_CHOICE_INPUT_OzQjTjKX = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_OzQjTjKX == 3){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.potion_health;
 ...
 } else if (USER_CHOICE_INPUT_OzQjTjKX == 3) { USER_CHOICE_INPUT_OzQjTjKX = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_OzQjTjKX == 4){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.bandage_health;
 ...
 } else if (USER_CHOICE_INPUT_OzQjTjKX == 4) { USER_CHOICE_INPUT_OzQjTjKX = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_OzQjTjKX == 5){
 ...
 } else if (USER_CHOICE_INPUT_OzQjTjKX == 5) { USER_CHOICE_INPUT_OzQjTjKX = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_OzQjTjKX == 6){
    roll=Random_Int_Num(PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE-13, PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE+13);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_OzQjTjKX == 6) { USER_CHOICE_INPUT_OzQjTjKX = 7; } 
...
DEFINED_LOCATION_TheEnd();
  ...
  if (The_dragon_of_smaguron_health < 400 && Random_Int_Num(1, 3) == 3) {
    ...
    int USER_CHOICE_INPUT_pWfgFRH6 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_pWfgFRH6 == 1){
  ...
  if (USER_CHOICE_INPUT_pWfgFRH6 == 2){
    PLAYER_STRUCT.Health_point+=4;
  }
    ...
    int USER_CHOICE_INPUT_3OJF2E3C = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_3OJF2E3C == 1){
  ...
  if (USER_CHOICE_INPUT_3OJF2E3C == 2){
  ...
  if (USER_CHOICE_INPUT_3OJF2E3C == 3){
