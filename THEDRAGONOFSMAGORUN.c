...
void DEFINED_LOCATION_DebugMenu(){
    ...
    int USER_CHOICE_INPUT_eLYvG4B = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_eLYvG4B == 1){

DEFINED_LOCATION_The_local_pub();
  }

  if (USER_CHOICE_INPUT_eLYvG4B == 2){
  ...
  if (USER_CHOICE_INPUT_eLYvG4B == 3){
  ...
  if (USER_CHOICE_INPUT_eLYvG4B == 4){
  ...
  if (USER_CHOICE_INPUT_eLYvG4B == 5){
  ...
  if (USER_CHOICE_INPUT_eLYvG4B == 6){
    ...
    int USER_CHOICE_INPUT_kkvtl8uK = COMPILER_TOOL_GET_INPUT(9);

  if (USER_CHOICE_INPUT_kkvtl8uK == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_kkvtl8uK == 2){

DEFINED_LOCATION_Street();
  }

  if (USER_CHOICE_INPUT_kkvtl8uK == 3){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_kkvtl8uK == 4){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_kkvtl8uK == 5){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_kkvtl8uK == 6){

DEFINED_LOCATION_FightTheDragon();
  }

  if (USER_CHOICE_INPUT_kkvtl8uK == 7){

DEFINED_LOCATION_House();
  }

  if (USER_CHOICE_INPUT_kkvtl8uK == 8){

DEFINED_LOCATION_TheEnd();
  }

  if (USER_CHOICE_INPUT_kkvtl8uK == 9){
...
void DEFINED_LOCATION_The_local_pub(){
    ...
    int USER_CHOICE_INPUT_3ctPyP8g = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_3ctPyP8g == 1){
    ...
    int USER_CHOICE_INPUT_JfMAN88 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_JfMAN88 == 1){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_JfMAN88 == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_3ctPyP8g == 2){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_3ctPyP8g == 3){
...
void DEFINED_LOCATION_Garden(){
  if (PLAYER_STRUCT.VisitedGarden == false) {
    ...
    int USER_CHOICE_INPUT_04VyJJIY = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_04VyJJIY == 1){
    PLAYER_STRUCT.Gold+=PLAYER_STRUCT.money_on_people_in_Garden;
  }

  if (USER_CHOICE_INPUT_04VyJJIY == 2){
...
DEFINED_LOCATION_Bar();
  ...
  if (PLAYER_STRUCT.VisitedGarden == true) {
    ...
    int USER_CHOICE_INPUT_BE8W2Y6B = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_BE8W2Y6B == 1){
  if (PLAYER_STRUCT.Gold >= 50 && PLAYER_STRUCT.Boost_of_internal_power_for_one_attack == true) {
    ...
    int USER_CHOICE_INPUT_3iF3UqH9 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_3iF3UqH9 == 1){
  ...
  if (USER_CHOICE_INPUT_3iF3UqH9 == 2){
  ...
  if (USER_CHOICE_INPUT_BE8W2Y6B == 2){
...
void DEFINED_LOCATION_Bar(){
  if (PLAYER_STRUCT.VisitedBar == false) {
    ...
    int USER_CHOICE_INPUT_GbtMdrlG = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_GbtMdrlG == 1){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (USER_CHOICE_INPUT_GbtMdrlG == 2){
  ...
  if (USER_CHOICE_INPUT_GbtMdrlG == 3){
    ...
    int USER_CHOICE_INPUT_aYl3Yggc = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_aYl3Yggc == 1){
    PLAYER_STRUCT.Gold-=1;
  ...
  if (USER_CHOICE_INPUT_aYl3Yggc == 2){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (PLAYER_STRUCT.CanLeaveBar) printf("\n6. ... (leave)"); 
    ...
    int USER_CHOICE_INPUT_ETEUwne3 = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_ETEUwne3 == 1){
  ...
  if (USER_CHOICE_INPUT_ETEUwne3 == 2){
  ...
  if (USER_CHOICE_INPUT_ETEUwne3 == 3){
...
DEFINED_LOCATION_GamblingTable();
  ...
  if (USER_CHOICE_INPUT_ETEUwne3 == 4){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_ETEUwne3 == 5){
...
DEFINED_LOCATION_Street();
 ...
 if (PLAYER_STRUCT.CanLeaveBar){
  ...
  if (USER_CHOICE_INPUT_ETEUwne3 == 6){
...
DEFINED_LOCATION_Street();
 ...
 } else if (USER_CHOICE_INPUT_ETEUwne3 == 6) { USER_CHOICE_INPUT_ETEUwne3 = 7; } 
...
void DEFINED_LOCATION_GamblingTable(){
  ...
  if (PLAYER_STRUCT.Gold >= 1000) printf("\n6. Bet 1000"); 
    ...
    int USER_CHOICE_INPUT_x5HS2CWf = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_x5HS2CWf == 1){
...
DEFINED_LOCATION_Bar();
 ...
 if (PLAYER_STRUCT.Gold >= 5){
  ...
  if (USER_CHOICE_INPUT_x5HS2CWf == 2){
    playerBet=5;
  }

 } else if (USER_CHOICE_INPUT_x5HS2CWf == 2) { USER_CHOICE_INPUT_x5HS2CWf = 3; } 

 if (PLAYER_STRUCT.Gold >= 10){

  if (USER_CHOICE_INPUT_x5HS2CWf == 3){
    playerBet=10;
  }

 } else if (USER_CHOICE_INPUT_x5HS2CWf == 3) { USER_CHOICE_INPUT_x5HS2CWf = 4; } 

 if (PLAYER_STRUCT.Gold >= 20){

  if (USER_CHOICE_INPUT_x5HS2CWf == 4){
    playerBet=20;
  }

 } else if (USER_CHOICE_INPUT_x5HS2CWf == 4) { USER_CHOICE_INPUT_x5HS2CWf = 5; } 

 if (PLAYER_STRUCT.Gold >= 50){

  if (USER_CHOICE_INPUT_x5HS2CWf == 5){
    playerBet=50;
  }

 } else if (USER_CHOICE_INPUT_x5HS2CWf == 5) { USER_CHOICE_INPUT_x5HS2CWf = 6; } 

 if (PLAYER_STRUCT.Gold >= 1000){

  if (USER_CHOICE_INPUT_x5HS2CWf == 6){
    playerBet=1000;
  }

 } else if (USER_CHOICE_INPUT_x5HS2CWf == 6) { USER_CHOICE_INPUT_x5HS2CWf = 7; } 
  ...
  if (playerRoll == 20) {
    ...
    int USER_CHOICE_INPUT_pJlyMKai = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_pJlyMKai == 1){
  if (playerRoll > dealerRoll) {

    COMPILER_TOOL_PRINT_TUI();
    printf("%s%d", "You won:", playerBet);
    COMPILER_TOOL_WAIT_FOR_INPUT();
  ...
  if (USER_CHOICE_INPUT_pJlyMKai == 2){
  if (playerRoll < dealerRoll) {
  ...
  if (USER_CHOICE_INPUT_pJlyMKai == 3){
  if (playerRoll == dealerRoll) {
...
void DEFINED_LOCATION_Street(){
    ...
    int USER_CHOICE_INPUT_zyrNL4iC = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_zyrNL4iC == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_zyrNL4iC == 2){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_zyrNL4iC == 3){

DEFINED_LOCATION_Shop();
  }

  if (USER_CHOICE_INPUT_zyrNL4iC == 4){
...
void DEFINED_LOCATION_Shop(){
  if (PLAYER_STRUCT.VisitedShop == false) {
    ...
    int USER_CHOICE_INPUT_VElhwHm = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_VElhwHm == 1){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_VElhwHm == 2){
  if (PLAYER_STRUCT.Gold >= 10) {
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_VElhwHm == 3){
...
void DEFINED_LOCATION_Forrest(){
  if (PLAYER_STRUCT.VisitedForrest == false) {
    ...
    int USER_CHOICE_INPUT_74Wz95A = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_74Wz95A == 1){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_74Wz95A == 2){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_74Wz95A == 3){
...
void DEFINED_LOCATION_Field(){
    ...
    int USER_CHOICE_INPUT_w1Kas2Oj = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_w1Kas2Oj == 1){
    ...
    int USER_CHOICE_INPUT_pCtbrO0T = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_pCtbrO0T == 1){
  ...
  if (USER_CHOICE_INPUT_pCtbrO0T == 2){
  ...
  if (bad == true) {
    ...
    int USER_CHOICE_INPUT_PwfisEBf = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_PwfisEBf == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_PwfisEBf == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_PwfisEBf == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_w1Kas2Oj == 2){
    ...
    int USER_CHOICE_INPUT_YeA5rzI = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_YeA5rzI == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_YeA5rzI == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_YeA5rzI == 3){
...
DEFINED_LOCATION_WitchFight();
    ...
    int USER_CHOICE_INPUT_plZp0n2 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_plZp0n2 == 1){
    ...
    int USER_CHOICE_INPUT_OyFJKD4P = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_OyFJKD4P == 1){
...
DEFINED_LOCATION_Basement();
  ...
  if (USER_CHOICE_INPUT_OyFJKD4P == 2){
...
DEFINED_LOCATION_Field();
  ...
  if (USER_CHOICE_INPUT_plZp0n2 == 2){
...
void DEFINED_LOCATION_WitchFight(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_0gWSbame = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_0gWSbame == 1){
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_0gWSbame == 2){
 ...
 } else if (USER_CHOICE_INPUT_0gWSbame == 2) { USER_CHOICE_INPUT_0gWSbame = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_0gWSbame == 3){
 ...
 } else if (USER_CHOICE_INPUT_0gWSbame == 3) { USER_CHOICE_INPUT_0gWSbame = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_0gWSbame == 4){
 ...
 } else if (USER_CHOICE_INPUT_0gWSbame == 4) { USER_CHOICE_INPUT_0gWSbame = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_0gWSbame == 5){
 ...
 } else if (USER_CHOICE_INPUT_0gWSbame == 5) { USER_CHOICE_INPUT_0gWSbame = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_0gWSbame == 6){
 ...
 } else if (USER_CHOICE_INPUT_0gWSbame == 6) { USER_CHOICE_INPUT_0gWSbame = 7; } 
...
DEFINED_LOCATION_House();
  ...
  if (witch_HP < 50 && Random_Int_Num(1, 2) == 1) {
    ...
    int USER_CHOICE_INPUT_KovlVIR3 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_KovlVIR3 == 1){
  ...
  if (USER_CHOICE_INPUT_KovlVIR3 == 2){
  ...
  if (Random_Int_Num(1, 15) == 1) printf("\n5. Smack that booty"); 
    ...
    int USER_CHOICE_INPUT_G3UWCFX2 = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_G3UWCFX2 == 1){
 ...
 if (Random_Int_Num(1, 3) == 1){
  ...
  if (USER_CHOICE_INPUT_G3UWCFX2 == 2){
 ...
 } else if (USER_CHOICE_INPUT_G3UWCFX2 == 2) { USER_CHOICE_INPUT_G3UWCFX2 = 3; } 

 if (Random_Int_Num(1, 3) == 1){

  if (USER_CHOICE_INPUT_G3UWCFX2 == 3){
 ...
 } else if (USER_CHOICE_INPUT_G3UWCFX2 == 3) { USER_CHOICE_INPUT_G3UWCFX2 = 4; } 

 if (Random_Int_Num(1, 4) == 1){

  if (USER_CHOICE_INPUT_G3UWCFX2 == 4){
 ...
 } else if (USER_CHOICE_INPUT_G3UWCFX2 == 4) { USER_CHOICE_INPUT_G3UWCFX2 = 5; } 

 if (Random_Int_Num(1, 15) == 1){

  if (USER_CHOICE_INPUT_G3UWCFX2 == 5){
 ...
 } else if (USER_CHOICE_INPUT_G3UWCFX2 == 5) { USER_CHOICE_INPUT_G3UWCFX2 = 6; } 
...
void DEFINED_LOCATION_Old_Castle(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_oDZoI9ga = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_oDZoI9ga == 1){
  ...
  if (USER_CHOICE_INPUT_oDZoI9ga == 2){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_WaR0VHsY = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_WaR0VHsY == 1){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_WaR0VHsY == 2){
  ...
  if (USER_CHOICE_INPUT_WaR0VHsY == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_WaR0VHsY == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_oDZoI9ga == 3){
    ...
    int USER_CHOICE_INPUT_kXhYfWJv = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_kXhYfWJv == 1){
    ...
    int USER_CHOICE_INPUT_vmOR3Ye = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_vmOR3Ye == 1){
...
DEFINED_LOCATION_FightTheDragon();
  ...
  if (USER_CHOICE_INPUT_vmOR3Ye == 2){
  ...
  if (USER_CHOICE_INPUT_kXhYfWJv == 2){
...
void DEFINED_LOCATION_Bed_Room(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_lmtGPv59 = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_lmtGPv59 == 1){
  ...
  if (USER_CHOICE_INPUT_lmtGPv59 == 2){
    ...
    int USER_CHOICE_INPUT_H8EbXtTD = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_H8EbXtTD == 1){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_Pd1Movx = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_Pd1Movx == 1){
  ...
  if (USER_CHOICE_INPUT_Pd1Movx == 2){

DEFINED_LOCATION_Dining_Room();
  }

  if (USER_CHOICE_INPUT_Pd1Movx == 3){
...
DEFINED_LOCATION_Old_Castle();
  ...
  if (USER_CHOICE_INPUT_H8EbXtTD == 2){
  ...
  if (USER_CHOICE_INPUT_lmtGPv59 == 3){
  ...
  if (USER_CHOICE_INPUT_lmtGPv59 == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_lmtGPv59 == 5){
...
void DEFINED_LOCATION_FightTheDragon(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_t4DHEwxv = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_t4DHEwxv == 1){
    roll=Random_Int_Num(3, 8);
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_t4DHEwxv == 2){
    roll=Random_Int_Num(PLAYER_STRUCT.regular_sword_damage-3, PLAYER_STRUCT.regular_sword_damage+3);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_t4DHEwxv == 2) { USER_CHOICE_INPUT_t4DHEwxv = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_t4DHEwxv == 3){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.potion_health;
 ...
 } else if (USER_CHOICE_INPUT_t4DHEwxv == 3) { USER_CHOICE_INPUT_t4DHEwxv = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_t4DHEwxv == 4){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.bandage_health;
 ...
 } else if (USER_CHOICE_INPUT_t4DHEwxv == 4) { USER_CHOICE_INPUT_t4DHEwxv = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_t4DHEwxv == 5){
 ...
 } else if (USER_CHOICE_INPUT_t4DHEwxv == 5) { USER_CHOICE_INPUT_t4DHEwxv = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_t4DHEwxv == 6){
    roll=Random_Int_Num(PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE-13, PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE+13);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_t4DHEwxv == 6) { USER_CHOICE_INPUT_t4DHEwxv = 7; } 
...
DEFINED_LOCATION_TheEnd();
  ...
  if (The_dragon_of_smaguron_health < 400 && Random_Int_Num(1, 3) == 3) {
    ...
    int USER_CHOICE_INPUT_oxXHdz8 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_oxXHdz8 == 1){
  ...
  if (USER_CHOICE_INPUT_oxXHdz8 == 2){
    PLAYER_STRUCT.Health_point+=4;
  }
    ...
    int USER_CHOICE_INPUT_LxcPzqBC = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_LxcPzqBC == 1){
  ...
  if (USER_CHOICE_INPUT_LxcPzqBC == 2){
  ...
  if (USER_CHOICE_INPUT_LxcPzqBC == 3){
