...
void DEFINED_LOCATION_DebugMenu(){
    ...
    int USER_CHOICE_INPUT_x5EdwskK = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_x5EdwskK == 1){

DEFINED_LOCATION_The_local_pub();
  }

  if (USER_CHOICE_INPUT_x5EdwskK == 2){

    printf("\n1. up"); 

    printf("\n2. down"); 

    int USER_CHOICE_INPUT_oBvg0zR = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_oBvg0zR == 1){
    PLAYER_STRUCT.WORLD_LEVEL+=1;
  }

  if (USER_CHOICE_INPUT_oBvg0zR == 2){
    PLAYER_STRUCT.WORLD_LEVEL-=1;
  }

  }

  if (USER_CHOICE_INPUT_x5EdwskK == 3){
 ...
 printf("\n\n /> ");
  ...
  if (USER_CHOICE_INPUT_x5EdwskK == 4){
  ...
  if (USER_CHOICE_INPUT_x5EdwskK == 5){
    ...
    int USER_CHOICE_INPUT_pvL8pFhL = COMPILER_TOOL_GET_INPUT(9);

  if (USER_CHOICE_INPUT_pvL8pFhL == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_pvL8pFhL == 2){

DEFINED_LOCATION_Street();
  }

  if (USER_CHOICE_INPUT_pvL8pFhL == 3){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_pvL8pFhL == 4){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_pvL8pFhL == 5){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_pvL8pFhL == 6){

DEFINED_LOCATION_FightTheDragon();
  }

  if (USER_CHOICE_INPUT_pvL8pFhL == 7){

DEFINED_LOCATION_House();
  }

  if (USER_CHOICE_INPUT_pvL8pFhL == 8){

DEFINED_LOCATION_TheEnd();
  }

  if (USER_CHOICE_INPUT_pvL8pFhL == 9){
...
void DEFINED_LOCATION_The_local_pub(){
    ...
    int USER_CHOICE_INPUT_bwJfa9xz = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_bwJfa9xz == 1){
    ...
    int USER_CHOICE_INPUT_Ub5jfy9Y = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_Ub5jfy9Y == 1){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_Ub5jfy9Y == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_bwJfa9xz == 2){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_bwJfa9xz == 3){
...
void DEFINED_LOCATION_Garden(){
  if (PLAYER_STRUCT.VisitedGarden == false) {
    ...
    int USER_CHOICE_INPUT_FZ1aNk7c = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_FZ1aNk7c == 1){
    PLAYER_STRUCT.Gold+=PLAYER_STRUCT.money_on_people_in_Garden;
  }

  if (USER_CHOICE_INPUT_FZ1aNk7c == 2){
...
DEFINED_LOCATION_Bar();
  ...
  if (PLAYER_STRUCT.VisitedGarden == true) {
    ...
    int USER_CHOICE_INPUT_6XOZLkdf = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_6XOZLkdf == 1){
  if (PLAYER_STRUCT.Gold >= 50 && PLAYER_STRUCT.Boost_of_internal_power_for_one_attack == true) {

    COMPILER_TOOL_PRINT_TUI();
    printf("%s", "ohh... I have too much Gold... i can ditch something for more gold... is that\nwhat i want?");
    COMPILER_TOOL_WAIT_FOR_INPUT();
    ...
    int USER_CHOICE_INPUT_mlsPc3j4 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_mlsPc3j4 == 1){
  ...
  if (USER_CHOICE_INPUT_mlsPc3j4 == 2){
  ...
  if (USER_CHOICE_INPUT_6XOZLkdf == 2){
...
void DEFINED_LOCATION_Bar(){
  if (PLAYER_STRUCT.VisitedBar == false) {
    ...
    int USER_CHOICE_INPUT_9c51YG9u = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_9c51YG9u == 1){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (USER_CHOICE_INPUT_9c51YG9u == 2){
  ...
  if (USER_CHOICE_INPUT_9c51YG9u == 3){
    ...
    int USER_CHOICE_INPUT_Wf3gk5F = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_Wf3gk5F == 1){
    PLAYER_STRUCT.Gold-=1;
  ...
  if (USER_CHOICE_INPUT_Wf3gk5F == 2){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (PLAYER_STRUCT.CanLeaveBar) printf("\n6. ... (leave)"); 
    ...
    int USER_CHOICE_INPUT_1WPmWpRx = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_1WPmWpRx == 1){
  ...
  if (USER_CHOICE_INPUT_1WPmWpRx == 2){
  ...
  if (USER_CHOICE_INPUT_1WPmWpRx == 3){
...
DEFINED_LOCATION_GamblingTable();
  ...
  if (USER_CHOICE_INPUT_1WPmWpRx == 4){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_1WPmWpRx == 5){
...
DEFINED_LOCATION_Street();
 ...
 if (PLAYER_STRUCT.CanLeaveBar){
  ...
  if (USER_CHOICE_INPUT_1WPmWpRx == 6){
...
DEFINED_LOCATION_Street();
 ...
 } else if (USER_CHOICE_INPUT_1WPmWpRx == 6) { USER_CHOICE_INPUT_1WPmWpRx = 7; } 
...
void DEFINED_LOCATION_GamblingTable(){
  ...
  if (PLAYER_STRUCT.Gold >= 50) printf("\n5. Bet 50"); 
    ...
    int USER_CHOICE_INPUT_KDUq1DsK = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_KDUq1DsK == 1){
...
DEFINED_LOCATION_Bar();
 ...
 if (PLAYER_STRUCT.Gold >= 5){
  ...
  if (USER_CHOICE_INPUT_KDUq1DsK == 2){
    playerBet=5;
  }

 } else if (USER_CHOICE_INPUT_KDUq1DsK == 2) { USER_CHOICE_INPUT_KDUq1DsK = 3; } 

 if (PLAYER_STRUCT.Gold >= 10){

  if (USER_CHOICE_INPUT_KDUq1DsK == 3){
    playerBet=10;
  }

 } else if (USER_CHOICE_INPUT_KDUq1DsK == 3) { USER_CHOICE_INPUT_KDUq1DsK = 4; } 

 if (PLAYER_STRUCT.Gold >= 20){

  if (USER_CHOICE_INPUT_KDUq1DsK == 4){
    playerBet=20;
  }

 } else if (USER_CHOICE_INPUT_KDUq1DsK == 4) { USER_CHOICE_INPUT_KDUq1DsK = 5; } 

 if (PLAYER_STRUCT.Gold >= 50){

  if (USER_CHOICE_INPUT_KDUq1DsK == 5){
    playerBet=50;
  }

 } else if (USER_CHOICE_INPUT_KDUq1DsK == 5) { USER_CHOICE_INPUT_KDUq1DsK = 6; } 
  ...
  if (playerRoll == 20) {
    ...
    int USER_CHOICE_INPUT_kpicwEd = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_kpicwEd == 1){
  ...
  if (USER_CHOICE_INPUT_kpicwEd == 2){
  if (playerRoll < dealerRoll) {
    PLAYER_STRUCT.Gold+=playerBet;
  }
  else {
  ...
  if (USER_CHOICE_INPUT_kpicwEd == 3){
  if (playerRoll == dealerRoll) {
...
void DEFINED_LOCATION_Street(){
    ...
    int USER_CHOICE_INPUT_LMnZWp = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_LMnZWp == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_LMnZWp == 2){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_LMnZWp == 3){

DEFINED_LOCATION_Shop();
  }

  if (USER_CHOICE_INPUT_LMnZWp == 4){
...
void DEFINED_LOCATION_Shop(){
  if (PLAYER_STRUCT.VisitedShop == false) {
    ...
    int USER_CHOICE_INPUT_Yc4xNtTJ = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_Yc4xNtTJ == 1){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_Yc4xNtTJ == 2){
  if (PLAYER_STRUCT.Gold >= 10) {
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_Yc4xNtTJ == 3){
...
void DEFINED_LOCATION_Forrest(){
  if (PLAYER_STRUCT.VisitedForrest == false) {
    ...
    int USER_CHOICE_INPUT_Zn3lhtUF = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_Zn3lhtUF == 1){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_Zn3lhtUF == 2){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_Zn3lhtUF == 3){
...
void DEFINED_LOCATION_Field(){
    ...
    int USER_CHOICE_INPUT_pViQPW7i = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_pViQPW7i == 1){
    ...
    int USER_CHOICE_INPUT_MxNQlyf4 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_MxNQlyf4 == 1){
  ...
  if (USER_CHOICE_INPUT_MxNQlyf4 == 2){
  ...
  if (bad == true) {
    ...
    int USER_CHOICE_INPUT_kbstpAm = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_kbstpAm == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_kbstpAm == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_kbstpAm == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_pViQPW7i == 2){
    ...
    int USER_CHOICE_INPUT_asOU8gTX = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_asOU8gTX == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_asOU8gTX == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_asOU8gTX == 3){
...
DEFINED_LOCATION_WitchFight();
    ...
    int USER_CHOICE_INPUT_H3XN8cIx = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_H3XN8cIx == 1){
    ...
    int USER_CHOICE_INPUT_7FNDF3PU = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_7FNDF3PU == 1){
...
DEFINED_LOCATION_Basement();
  ...
  if (USER_CHOICE_INPUT_7FNDF3PU == 2){
...
DEFINED_LOCATION_Field();
  ...
  if (USER_CHOICE_INPUT_H3XN8cIx == 2){
...
void DEFINED_LOCATION_WitchFight(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_tJHmt6Bl = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_tJHmt6Bl == 1){
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_tJHmt6Bl == 2){
 ...
 } else if (USER_CHOICE_INPUT_tJHmt6Bl == 2) { USER_CHOICE_INPUT_tJHmt6Bl = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_tJHmt6Bl == 3){
 ...
 } else if (USER_CHOICE_INPUT_tJHmt6Bl == 3) { USER_CHOICE_INPUT_tJHmt6Bl = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_tJHmt6Bl == 4){
 ...
 } else if (USER_CHOICE_INPUT_tJHmt6Bl == 4) { USER_CHOICE_INPUT_tJHmt6Bl = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_tJHmt6Bl == 5){

    COMPILER_TOOL_PRINT_TUI();
    printf("%s%s", "When hand comes to hilt, question comes to heart, from soul is given heaven\'s\nanswer via either divine balancing scale or sword.", "For there is either hope,\nor there is not, and one way or another, suffering must end.");
    COMPILER_TOOL_WAIT_FOR_INPUT();
    PLAYER_STRUCT.GreatSwordReady = true;
  }

 } else if (USER_CHOICE_INPUT_tJHmt6Bl == 5) { USER_CHOICE_INPUT_tJHmt6Bl = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_tJHmt6Bl == 6){
 ...
 } else if (USER_CHOICE_INPUT_tJHmt6Bl == 6) { USER_CHOICE_INPUT_tJHmt6Bl = 7; } 
...
DEFINED_LOCATION_House();
  ...
  if (witch_HP < 50 && Random_Int_Num(1, 2) == 1) {
    ...
    int USER_CHOICE_INPUT_djlmGzEX = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_djlmGzEX == 1){
  ...
  if (USER_CHOICE_INPUT_djlmGzEX == 2){
  ...
  if (Random_Int_Num(1, 15) == 1) printf("\n5. Smack that booty"); 
    ...
    int USER_CHOICE_INPUT_tAlBNRkq = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_tAlBNRkq == 1){
 ...
 if (Random_Int_Num(1, 3) == 1){
  ...
  if (USER_CHOICE_INPUT_tAlBNRkq == 2){
 ...
 } else if (USER_CHOICE_INPUT_tAlBNRkq == 2) { USER_CHOICE_INPUT_tAlBNRkq = 3; } 

 if (Random_Int_Num(1, 3) == 1){

  if (USER_CHOICE_INPUT_tAlBNRkq == 3){
 ...
 } else if (USER_CHOICE_INPUT_tAlBNRkq == 3) { USER_CHOICE_INPUT_tAlBNRkq = 4; } 

 if (Random_Int_Num(1, 4) == 1){

  if (USER_CHOICE_INPUT_tAlBNRkq == 4){
 ...
 } else if (USER_CHOICE_INPUT_tAlBNRkq == 4) { USER_CHOICE_INPUT_tAlBNRkq = 5; } 

 if (Random_Int_Num(1, 15) == 1){

  if (USER_CHOICE_INPUT_tAlBNRkq == 5){
 ...
 } else if (USER_CHOICE_INPUT_tAlBNRkq == 5) { USER_CHOICE_INPUT_tAlBNRkq = 6; } 
...
void DEFINED_LOCATION_Old_Castle(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_DmXhGVx = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_DmXhGVx == 1){
  ...
  if (USER_CHOICE_INPUT_DmXhGVx == 2){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_DDe2fvul = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_DDe2fvul == 1){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_DDe2fvul == 2){
  ...
  if (USER_CHOICE_INPUT_DDe2fvul == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_DDe2fvul == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_DmXhGVx == 3){
    ...
    int USER_CHOICE_INPUT_oraMFLCt = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_oraMFLCt == 1){
    ...
    int USER_CHOICE_INPUT_FtQXmIQl = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_FtQXmIQl == 1){
...
DEFINED_LOCATION_FightTheDragon();
  ...
  if (USER_CHOICE_INPUT_FtQXmIQl == 2){
  ...
  if (USER_CHOICE_INPUT_oraMFLCt == 2){
...
void DEFINED_LOCATION_Bed_Room(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_JL1iFfoM = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_JL1iFfoM == 1){
  ...
  if (USER_CHOICE_INPUT_JL1iFfoM == 2){
    ...
    int USER_CHOICE_INPUT_swfpZ2UE = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_swfpZ2UE == 1){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_RLQUbgM9 = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_RLQUbgM9 == 1){
  ...
  if (USER_CHOICE_INPUT_RLQUbgM9 == 2){

DEFINED_LOCATION_Dining_Room();
  }

  if (USER_CHOICE_INPUT_RLQUbgM9 == 3){
...
DEFINED_LOCATION_Old_Castle();
  ...
  if (USER_CHOICE_INPUT_swfpZ2UE == 2){
  ...
  if (USER_CHOICE_INPUT_JL1iFfoM == 3){
  ...
  if (USER_CHOICE_INPUT_JL1iFfoM == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_JL1iFfoM == 5){
...
void DEFINED_LOCATION_FightTheDragon(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_eUhJxEib = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_eUhJxEib == 1){
    roll=Random_Int_Num(3, 8);
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_eUhJxEib == 2){
    roll=Random_Int_Num(PLAYER_STRUCT.regular_sword_damage-3, PLAYER_STRUCT.regular_sword_damage+3);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_eUhJxEib == 2) { USER_CHOICE_INPUT_eUhJxEib = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_eUhJxEib == 3){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.potion_health;
 ...
 } else if (USER_CHOICE_INPUT_eUhJxEib == 3) { USER_CHOICE_INPUT_eUhJxEib = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_eUhJxEib == 4){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.bandage_health;
 ...
 } else if (USER_CHOICE_INPUT_eUhJxEib == 4) { USER_CHOICE_INPUT_eUhJxEib = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_eUhJxEib == 5){
 ...
 } else if (USER_CHOICE_INPUT_eUhJxEib == 5) { USER_CHOICE_INPUT_eUhJxEib = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_eUhJxEib == 6){
    roll=Random_Int_Num(PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE-13, PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE+13);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_eUhJxEib == 6) { USER_CHOICE_INPUT_eUhJxEib = 7; } 
...
DEFINED_LOCATION_TheEnd();
  ...
  if (The_dragon_of_smaguron_health < 400 && Random_Int_Num(1, 3) == 3) {
    ...
    int USER_CHOICE_INPUT_m8UBzoc = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_m8UBzoc == 1){
  ...
  if (USER_CHOICE_INPUT_m8UBzoc == 2){
    PLAYER_STRUCT.Health_point+=4;
  }
    ...
    int USER_CHOICE_INPUT_Sqlosa9T = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_Sqlosa9T == 1){
  ...
  if (USER_CHOICE_INPUT_Sqlosa9T == 2){
  ...
  if (USER_CHOICE_INPUT_Sqlosa9T == 3){
