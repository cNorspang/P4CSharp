...
void DEFINED_LOCATION_DebugMenu(){
    ...
    int USER_CHOICE_INPUT_vTmZGrkU = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_vTmZGrkU == 1){

DEFINED_LOCATION_The_local_pub();
  }

  if (USER_CHOICE_INPUT_vTmZGrkU == 2){

    printf("\n1. up"); 

    printf("\n2. down"); 

    int USER_CHOICE_INPUT_rpXcn1Pl = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_rpXcn1Pl == 1){
    PLAYER_STRUCT.WORLD_LEVEL+=1;
  }

  if (USER_CHOICE_INPUT_rpXcn1Pl == 2){
    PLAYER_STRUCT.WORLD_LEVEL-=1;
  }

  }

  if (USER_CHOICE_INPUT_vTmZGrkU == 3){
 ...
 printf("\n\n /> ");
  ...
  if (USER_CHOICE_INPUT_vTmZGrkU == 4){
  ...
  if (USER_CHOICE_INPUT_vTmZGrkU == 5){
    ...
    int USER_CHOICE_INPUT_KToJD5v4 = COMPILER_TOOL_GET_INPUT(9);

  if (USER_CHOICE_INPUT_KToJD5v4 == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_KToJD5v4 == 2){

DEFINED_LOCATION_Street();
  }

  if (USER_CHOICE_INPUT_KToJD5v4 == 3){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_KToJD5v4 == 4){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_KToJD5v4 == 5){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_KToJD5v4 == 6){

DEFINED_LOCATION_FightTheDragon();
  }

  if (USER_CHOICE_INPUT_KToJD5v4 == 7){

DEFINED_LOCATION_House();
  }

  if (USER_CHOICE_INPUT_KToJD5v4 == 8){

DEFINED_LOCATION_TheEnd();
  }

  if (USER_CHOICE_INPUT_KToJD5v4 == 9){
...
void DEFINED_LOCATION_The_local_pub(){
    ...
    int USER_CHOICE_INPUT_zGMUBPvU = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_zGMUBPvU == 1){
    ...
    int USER_CHOICE_INPUT_gWcftYVO = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_gWcftYVO == 1){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_gWcftYVO == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_zGMUBPvU == 2){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_zGMUBPvU == 3){
...
void DEFINED_LOCATION_Garden(){
  if (PLAYER_STRUCT.VisitedGarden == false) {
    ...
    int USER_CHOICE_INPUT_G1tsASY4 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_G1tsASY4 == 1){
    PLAYER_STRUCT.Gold+=PLAYER_STRUCT.money_on_people_in_Garden;
  }

  if (USER_CHOICE_INPUT_G1tsASY4 == 2){
...
DEFINED_LOCATION_Bar();
  ...
  if (PLAYER_STRUCT.VisitedGarden == true) {
    ...
    int USER_CHOICE_INPUT_YRd6aJW6 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_YRd6aJW6 == 1){
  if (PLAYER_STRUCT.Gold >= 50 && PLAYER_STRUCT.Boost_of_internal_power_for_one_attack == true) {
    ...
    int USER_CHOICE_INPUT_038K9twE = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_038K9twE == 1){
  ...
  if (USER_CHOICE_INPUT_038K9twE == 2){
  ...
  if (USER_CHOICE_INPUT_YRd6aJW6 == 2){
...
void DEFINED_LOCATION_Bar(){
  if (PLAYER_STRUCT.VisitedBar == false) {
    ...
    int USER_CHOICE_INPUT_PDpOIR = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_PDpOIR == 1){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (USER_CHOICE_INPUT_PDpOIR == 3){
    ...
    int USER_CHOICE_INPUT_kfB8V09P = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_kfB8V09P == 1){
    PLAYER_STRUCT.Gold-=1;
  ...
  if (USER_CHOICE_INPUT_kfB8V09P == 2){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (PLAYER_STRUCT.CanLeaveBar) printf("\n6. ... (leave)"); 
    ...
    int USER_CHOICE_INPUT_gP3oR3bR = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_gP3oR3bR == 1){
  ...
  if (USER_CHOICE_INPUT_gP3oR3bR == 2){
  ...
  if (USER_CHOICE_INPUT_gP3oR3bR == 3){
...
DEFINED_LOCATION_GamblingTable();
  ...
  if (USER_CHOICE_INPUT_gP3oR3bR == 4){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_gP3oR3bR == 5){
...
DEFINED_LOCATION_Street();
 ...
 if (PLAYER_STRUCT.CanLeaveBar){
  ...
  if (USER_CHOICE_INPUT_gP3oR3bR == 6){
...
DEFINED_LOCATION_Street();
 ...
 } else if (USER_CHOICE_INPUT_gP3oR3bR == 6) { USER_CHOICE_INPUT_gP3oR3bR = 7; } 
...
void DEFINED_LOCATION_GamblingTable(){
  ...
  if (PLAYER_STRUCT.Gold >= 50) printf("\n5. Bet 50"); 
    ...
    int USER_CHOICE_INPUT_sdc0ZXm = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_sdc0ZXm == 1){
...
DEFINED_LOCATION_Bar();
 ...
 if (PLAYER_STRUCT.Gold >= 5){
  ...
  if (USER_CHOICE_INPUT_sdc0ZXm == 2){
    playerBet=5;
  }

 } else if (USER_CHOICE_INPUT_sdc0ZXm == 2) { USER_CHOICE_INPUT_sdc0ZXm = 3; } 

 if (PLAYER_STRUCT.Gold >= 10){

  if (USER_CHOICE_INPUT_sdc0ZXm == 3){
    playerBet=10;
  }

 } else if (USER_CHOICE_INPUT_sdc0ZXm == 3) { USER_CHOICE_INPUT_sdc0ZXm = 4; } 

 if (PLAYER_STRUCT.Gold >= 20){

  if (USER_CHOICE_INPUT_sdc0ZXm == 4){
    playerBet=20;
  }

 } else if (USER_CHOICE_INPUT_sdc0ZXm == 4) { USER_CHOICE_INPUT_sdc0ZXm = 5; } 

 if (PLAYER_STRUCT.Gold >= 50){

  if (USER_CHOICE_INPUT_sdc0ZXm == 5){
    playerBet=50;
  }

 } else if (USER_CHOICE_INPUT_sdc0ZXm == 5) { USER_CHOICE_INPUT_sdc0ZXm = 6; } 
  ...
  if (playerRoll == 20) {
    ...
    int USER_CHOICE_INPUT_Q1L9Q48H = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_Q1L9Q48H == 1){
  ...
  if (USER_CHOICE_INPUT_Q1L9Q48H == 2){
  if (playerRoll < dealerRoll) {
    PLAYER_STRUCT.Gold+=playerBet;
  }
  else {
  ...
  if (USER_CHOICE_INPUT_Q1L9Q48H == 3){
  if (playerRoll == dealerRoll) {
...
void DEFINED_LOCATION_Street(){
    ...
    int USER_CHOICE_INPUT_7CPP2GdT = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_7CPP2GdT == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_7CPP2GdT == 2){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_7CPP2GdT == 3){

DEFINED_LOCATION_Shop();
  }

  if (USER_CHOICE_INPUT_7CPP2GdT == 4){
...
void DEFINED_LOCATION_Shop(){
  if (PLAYER_STRUCT.VisitedShop == false) {
    ...
    int USER_CHOICE_INPUT_WtkjJalq = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_WtkjJalq == 1){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_WtkjJalq == 2){
  if (PLAYER_STRUCT.Gold >= 10) {
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_WtkjJalq == 3){
...
void DEFINED_LOCATION_Forrest(){
  if (PLAYER_STRUCT.VisitedForrest == false) {
    ...
    int USER_CHOICE_INPUT_LfVIrj9D = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_LfVIrj9D == 1){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_LfVIrj9D == 2){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_LfVIrj9D == 3){
...
void DEFINED_LOCATION_Field(){
    ...
    int USER_CHOICE_INPUT_78MzS6Eg = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_78MzS6Eg == 1){
    ...
    int USER_CHOICE_INPUT_VIiso8gO = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_VIiso8gO == 1){
  ...
  if (USER_CHOICE_INPUT_VIiso8gO == 2){
  ...
  if (bad == true) {
    ...
    int USER_CHOICE_INPUT_yeaNrI27 = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_yeaNrI27 == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_yeaNrI27 == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_yeaNrI27 == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_78MzS6Eg == 2){
    ...
    int USER_CHOICE_INPUT_wFxf5Eop = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_wFxf5Eop == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_wFxf5Eop == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_wFxf5Eop == 3){
...
DEFINED_LOCATION_WitchFight();
    ...
    int USER_CHOICE_INPUT_wxpF9iLp = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_wxpF9iLp == 1){
    ...
    int USER_CHOICE_INPUT_Bg6gj3QF = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_Bg6gj3QF == 1){
...
DEFINED_LOCATION_Basement();
  ...
  if (USER_CHOICE_INPUT_Bg6gj3QF == 2){
...
DEFINED_LOCATION_Field();
  ...
  if (USER_CHOICE_INPUT_wxpF9iLp == 2){
...
void DEFINED_LOCATION_WitchFight(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_FziAVXzU = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_FziAVXzU == 1){
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_FziAVXzU == 2){
 ...
 } else if (USER_CHOICE_INPUT_FziAVXzU == 2) { USER_CHOICE_INPUT_FziAVXzU = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_FziAVXzU == 3){
 ...
 } else if (USER_CHOICE_INPUT_FziAVXzU == 3) { USER_CHOICE_INPUT_FziAVXzU = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_FziAVXzU == 4){
 ...
 } else if (USER_CHOICE_INPUT_FziAVXzU == 4) { USER_CHOICE_INPUT_FziAVXzU = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_FziAVXzU == 5){
 ...
 } else if (USER_CHOICE_INPUT_FziAVXzU == 5) { USER_CHOICE_INPUT_FziAVXzU = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_FziAVXzU == 6){
 ...
 } else if (USER_CHOICE_INPUT_FziAVXzU == 6) { USER_CHOICE_INPUT_FziAVXzU = 7; } 
...
DEFINED_LOCATION_House();
  ...
  if (witch_HP < 50 && Random_Int_Num(1, 2) == 1) {
    ...
    int USER_CHOICE_INPUT_dLJC7OsQ = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_dLJC7OsQ == 1){
  ...
  if (USER_CHOICE_INPUT_dLJC7OsQ == 2){
  ...
  if (Random_Int_Num(1, 15) == 1) printf("\n5. Smack that booty"); 
    ...
    int USER_CHOICE_INPUT_OEA31BA = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_OEA31BA == 1){
 ...
 if (Random_Int_Num(1, 3) == 1){
  ...
  if (USER_CHOICE_INPUT_OEA31BA == 2){
 ...
 } else if (USER_CHOICE_INPUT_OEA31BA == 2) { USER_CHOICE_INPUT_OEA31BA = 3; } 

 if (Random_Int_Num(1, 3) == 1){

  if (USER_CHOICE_INPUT_OEA31BA == 3){
 ...
 } else if (USER_CHOICE_INPUT_OEA31BA == 3) { USER_CHOICE_INPUT_OEA31BA = 4; } 

 if (Random_Int_Num(1, 4) == 1){

  if (USER_CHOICE_INPUT_OEA31BA == 4){
 ...
 } else if (USER_CHOICE_INPUT_OEA31BA == 4) { USER_CHOICE_INPUT_OEA31BA = 5; } 

 if (Random_Int_Num(1, 15) == 1){

  if (USER_CHOICE_INPUT_OEA31BA == 5){
 ...
 } else if (USER_CHOICE_INPUT_OEA31BA == 5) { USER_CHOICE_INPUT_OEA31BA = 6; } 
...
void DEFINED_LOCATION_Old_Castle(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_gdnMJSL4 = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_gdnMJSL4 == 1){
  ...
  if (USER_CHOICE_INPUT_gdnMJSL4 == 2){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_oW4HJrkE = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_oW4HJrkE == 1){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_oW4HJrkE == 2){
  ...
  if (USER_CHOICE_INPUT_oW4HJrkE == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_oW4HJrkE == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_gdnMJSL4 == 3){
    ...
    int USER_CHOICE_INPUT_2a5obw3 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_2a5obw3 == 1){
    ...
    int USER_CHOICE_INPUT_mkh4cONY = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_mkh4cONY == 1){
...
DEFINED_LOCATION_FightTheDragon();
  ...
  if (USER_CHOICE_INPUT_mkh4cONY == 2){
  ...
  if (USER_CHOICE_INPUT_2a5obw3 == 2){
...
void DEFINED_LOCATION_Bed_Room(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_ZVGEFkEX = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_ZVGEFkEX == 1){
  ...
  if (USER_CHOICE_INPUT_ZVGEFkEX == 2){
    ...
    int USER_CHOICE_INPUT_uJ8Vu6ch = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_uJ8Vu6ch == 1){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_48HrMnR2 = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_48HrMnR2 == 1){
  ...
  if (USER_CHOICE_INPUT_48HrMnR2 == 2){

DEFINED_LOCATION_Dining_Room();
  }

  if (USER_CHOICE_INPUT_48HrMnR2 == 3){
...
DEFINED_LOCATION_Old_Castle();
  ...
  if (USER_CHOICE_INPUT_uJ8Vu6ch == 2){
  ...
  if (USER_CHOICE_INPUT_ZVGEFkEX == 3){
  ...
  if (USER_CHOICE_INPUT_ZVGEFkEX == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_ZVGEFkEX == 5){
...
void DEFINED_LOCATION_FightTheDragon(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_UtvxRNiF = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_UtvxRNiF == 1){
    roll=Random_Int_Num(3, 8);
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_UtvxRNiF == 2){
    roll=Random_Int_Num(PLAYER_STRUCT.regular_sword_damage-3, PLAYER_STRUCT.regular_sword_damage+3);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_UtvxRNiF == 2) { USER_CHOICE_INPUT_UtvxRNiF = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_UtvxRNiF == 3){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.potion_health;
 ...
 } else if (USER_CHOICE_INPUT_UtvxRNiF == 3) { USER_CHOICE_INPUT_UtvxRNiF = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_UtvxRNiF == 4){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.bandage_health;
 ...
 } else if (USER_CHOICE_INPUT_UtvxRNiF == 4) { USER_CHOICE_INPUT_UtvxRNiF = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_UtvxRNiF == 5){
 ...
 } else if (USER_CHOICE_INPUT_UtvxRNiF == 5) { USER_CHOICE_INPUT_UtvxRNiF = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_UtvxRNiF == 6){
    roll=Random_Int_Num(PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE-13, PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE+13);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_UtvxRNiF == 6) { USER_CHOICE_INPUT_UtvxRNiF = 7; } 
...
DEFINED_LOCATION_TheEnd();
  ...
  if (The_dragon_of_smaguron_health < 400 && Random_Int_Num(1, 3) == 3) {
    ...
    int USER_CHOICE_INPUT_GXraBJ1G = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_GXraBJ1G == 1){
  ...
  if (USER_CHOICE_INPUT_GXraBJ1G == 2){
    PLAYER_STRUCT.Health_point+=4;
  }
    ...
    int USER_CHOICE_INPUT_NWIu0ZH2 = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_NWIu0ZH2 == 1){
  ...
  if (USER_CHOICE_INPUT_NWIu0ZH2 == 2){
  ...
  if (USER_CHOICE_INPUT_NWIu0ZH2 == 3){
