...
namespace SWAE
{
    public static class DebugPrinter
    {
        ...
        internal static bool ShowAnalysis;
        internal static bool isDebug;
        internal static bool themePick = true;

        public static void Ccwl(string msg)
        {
            if(ShowAnalysis) Console.WriteLine(ColorChange(CIndex++)+msg+ColorChange());
        }

        public static void Ccw(string msg)
        {
            if (ShowAnalysis) Console.Write(ColorChange(CIndex) + msg + ColorChange());
        }
        ...
        public static string ColorChange(int num = 0)
        {
            if (isDebug) { 
                ...
                string mNum = num == 0 ? "0" : $"38;5;{(themePick?NorspangsTheme:rainbow)[num % 6]}";
