...
public interface BetterAdvGmVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link BetterAdvGmParser#buffernode}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBuffernode(BetterAdvGmParser.BuffernodeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link BetterAdvGmParser#inBlock}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInBlock(BetterAdvGmParser.InBlockContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link BetterAdvGmParser#if_chain_statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIf_chain_statement(BetterAdvGmParser.If_chain_statementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link BetterAdvGmParser#else_if_statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElse_if_statement(BetterAdvGmParser.Else_if_statementContext ctx);
	/**
	 * Visit a parse tree produced by {@link BetterAdvGmParser#else_statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElse_statement(BetterAdvGmParser.Else_statementContext ctx);
	/**
