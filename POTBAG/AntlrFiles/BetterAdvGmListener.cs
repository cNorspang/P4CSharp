...
public interface IBetterAdvGmListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterCollection_int_assign([NotNull] BetterAdvGmParser.Collection_int_assignContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="BetterAdvGmParser.collection_int_assign"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCollection_int_assign([NotNull] BetterAdvGmParser.Collection_int_assignContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="BetterAdvGmParser.collection_string_assign"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterCollection_string_assign([NotNull] BetterAdvGmParser.Collection_string_assignContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="BetterAdvGmParser.collection_string_assign"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCollection_string_assign([NotNull] BetterAdvGmParser.Collection_string_assignContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterCollection_int_declaration([NotNull] BetterAdvGmParser.Collection_int_declarationContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="BetterAdvGmParser.collection_int_declaration"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCollection_int_declaration([NotNull] BetterAdvGmParser.Collection_int_declarationContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="BetterAdvGmParser.collection_string_declaration"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterCollection_string_declaration([NotNull] BetterAdvGmParser.Collection_string_declarationContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="BetterAdvGmParser.collection_string_declaration"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCollection_string_declaration([NotNull] BetterAdvGmParser.Collection_string_declarationContext context);
	/// <summary>
