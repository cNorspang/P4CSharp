...
public partial class BetterAdvGmBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IBetterAdvGmVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="BetterAdvGmParser.random"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitRandom([NotNull] BetterAdvGmParser.RandomContext context) { return VisitChildren(context); }
	/// <summary>
