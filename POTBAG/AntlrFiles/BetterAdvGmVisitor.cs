...
public interface IBetterAdvGmVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitCollection_int_assign([NotNull] BetterAdvGmParser.Collection_int_assignContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="BetterAdvGmParser.collection_string_assign"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitCollection_string_assign([NotNull] BetterAdvGmParser.Collection_string_assignContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitCollection_int_declaration([NotNull] BetterAdvGmParser.Collection_int_declarationContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="BetterAdvGmParser.collection_string_declaration"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitCollection_string_declaration([NotNull] BetterAdvGmParser.Collection_string_declarationContext context);
	/// <summary>
