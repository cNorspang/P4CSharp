...
| expression (TIMES_OPERATOR|DIVISION_OPERATOR) expression
...
int_assign
: (variable (ASSIGN_OPERATOR | COMPOUND_OPERATOR) expression END_STMT
| int_declaration ASSIGN_OPERATOR expression END_STMT)
;

string_assign
: (variable ASSIGN_OPERATOR string_obj END_STMT
| string_declaration ASSIGN_OPERATOR string_obj END_STMT)
;

input_assign
: (variable ASSIGN_OPERATOR input_statement
| string_declaration ASSIGN_OPERATOR input_statement
...
| bool_declaration ASSIGN_OPERATOR bool_obj END_STMT)
;
...
//Special Rules
predicate
: (variable BOOL_CMP_OPERATOR string_obj
