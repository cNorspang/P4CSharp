...
void DEFINED_LOCATION_DebugMenu(){
    ...
    int USER_CHOICE_INPUT_RL6L9vip = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_RL6L9vip == 1){

DEFINED_LOCATION_The_local_pub();
  }

  if (USER_CHOICE_INPUT_RL6L9vip == 2){
  ...
  if (USER_CHOICE_INPUT_RL6L9vip == 3){
  ...
  if (USER_CHOICE_INPUT_RL6L9vip == 4){
  ...
  if (USER_CHOICE_INPUT_RL6L9vip == 5){
  ...
  if (USER_CHOICE_INPUT_RL6L9vip == 6){
    ...
    int USER_CHOICE_INPUT_BkdV4Pi = COMPILER_TOOL_GET_INPUT(9);

  if (USER_CHOICE_INPUT_BkdV4Pi == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_BkdV4Pi == 2){

DEFINED_LOCATION_Street();
  }

  if (USER_CHOICE_INPUT_BkdV4Pi == 3){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_BkdV4Pi == 4){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_BkdV4Pi == 5){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_BkdV4Pi == 6){

DEFINED_LOCATION_FightTheDragon();
  }

  if (USER_CHOICE_INPUT_BkdV4Pi == 7){

DEFINED_LOCATION_House();
  }

  if (USER_CHOICE_INPUT_BkdV4Pi == 8){

DEFINED_LOCATION_TheEnd();
  }

  if (USER_CHOICE_INPUT_BkdV4Pi == 9){
...
void DEFINED_LOCATION_The_local_pub(){
    ...
    int USER_CHOICE_INPUT_HAQJufwU = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_HAQJufwU == 1){
    ...
    int USER_CHOICE_INPUT_bSjfxpnJ = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_bSjfxpnJ == 1){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_bSjfxpnJ == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_HAQJufwU == 2){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_HAQJufwU == 3){
...
void DEFINED_LOCATION_Garden(){
  if (PLAYER_STRUCT.VisitedGarden == false) {
    ...
    int USER_CHOICE_INPUT_ITznzFXJ = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_ITznzFXJ == 1){
    PLAYER_STRUCT.Gold+=PLAYER_STRUCT.money_on_people_in_Garden;
  }

  if (USER_CHOICE_INPUT_ITznzFXJ == 2){
...
DEFINED_LOCATION_Bar();
  ...
  if (PLAYER_STRUCT.VisitedGarden == true) {
    ...
    int USER_CHOICE_INPUT_FPBX4m09 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_FPBX4m09 == 1){
  if (PLAYER_STRUCT.Gold >= 50 && PLAYER_STRUCT.Boost_of_internal_power_for_one_attack == true) {
    ...
    int USER_CHOICE_INPUT_07TB52LP = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_07TB52LP == 1){
  ...
  if (USER_CHOICE_INPUT_07TB52LP == 2){
  ...
  if (USER_CHOICE_INPUT_FPBX4m09 == 2){
...
void DEFINED_LOCATION_Bar(){
  if (PLAYER_STRUCT.VisitedBar == false) {
    ...
    int USER_CHOICE_INPUT_CdIqcfAO = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_CdIqcfAO == 1){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (USER_CHOICE_INPUT_CdIqcfAO == 2){
  ...
  if (USER_CHOICE_INPUT_CdIqcfAO == 3){
    ...
    int USER_CHOICE_INPUT_noaAZVjX = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_noaAZVjX == 1){
    PLAYER_STRUCT.Gold-=1;
  ...
  if (USER_CHOICE_INPUT_noaAZVjX == 2){
    PLAYER_STRUCT.Gold-=2;
  ...
  if (PLAYER_STRUCT.CanLeaveBar) printf("\n6. ... (leave)"); 
    ...
    int USER_CHOICE_INPUT_zQ8QWpdr = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_zQ8QWpdr == 1){
  ...
  if (USER_CHOICE_INPUT_zQ8QWpdr == 2){
  ...
  if (USER_CHOICE_INPUT_zQ8QWpdr == 3){
...
DEFINED_LOCATION_GamblingTable();
  ...
  if (USER_CHOICE_INPUT_zQ8QWpdr == 4){
...
DEFINED_LOCATION_Garden();
  ...
  if (USER_CHOICE_INPUT_zQ8QWpdr == 5){
...
DEFINED_LOCATION_Street();
 ...
 if (PLAYER_STRUCT.CanLeaveBar){
  ...
  if (USER_CHOICE_INPUT_zQ8QWpdr == 6){
...
DEFINED_LOCATION_Street();
 ...
 } else if (USER_CHOICE_INPUT_zQ8QWpdr == 6) { USER_CHOICE_INPUT_zQ8QWpdr = 7; } 
...
void DEFINED_LOCATION_GamblingTable(){
  ...
  if (PLAYER_STRUCT.Gold >= 1000) printf("\n6. Bet 1000"); 
    ...
    int USER_CHOICE_INPUT_xjhMmlsa = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_xjhMmlsa == 1){
...
DEFINED_LOCATION_Bar();
 ...
 if (PLAYER_STRUCT.Gold >= 5){
  ...
  if (USER_CHOICE_INPUT_xjhMmlsa == 2){
    playerBet=5;
  }

 } else if (USER_CHOICE_INPUT_xjhMmlsa == 2) { USER_CHOICE_INPUT_xjhMmlsa = 3; } 

 if (PLAYER_STRUCT.Gold >= 10){

  if (USER_CHOICE_INPUT_xjhMmlsa == 3){
    playerBet=10;
  }

 } else if (USER_CHOICE_INPUT_xjhMmlsa == 3) { USER_CHOICE_INPUT_xjhMmlsa = 4; } 

 if (PLAYER_STRUCT.Gold >= 20){

  if (USER_CHOICE_INPUT_xjhMmlsa == 4){
    playerBet=20;
  }

 } else if (USER_CHOICE_INPUT_xjhMmlsa == 4) { USER_CHOICE_INPUT_xjhMmlsa = 5; } 

 if (PLAYER_STRUCT.Gold >= 50){

  if (USER_CHOICE_INPUT_xjhMmlsa == 5){
    playerBet=50;
  }

 } else if (USER_CHOICE_INPUT_xjhMmlsa == 5) { USER_CHOICE_INPUT_xjhMmlsa = 6; } 

 if (PLAYER_STRUCT.Gold >= 1000){

  if (USER_CHOICE_INPUT_xjhMmlsa == 6){
    playerBet=1000;
  }

 } else if (USER_CHOICE_INPUT_xjhMmlsa == 6) { USER_CHOICE_INPUT_xjhMmlsa = 7; } 
  ...
  if (playerRoll == 20) {
    ...
    int USER_CHOICE_INPUT_p3BRmrvW = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_p3BRmrvW == 1){
  ...
  if (USER_CHOICE_INPUT_p3BRmrvW == 2){
  if (playerRoll < dealerRoll) {
    PLAYER_STRUCT.Gold+=playerBet;
  }
  else {
  ...
  if (USER_CHOICE_INPUT_p3BRmrvW == 3){
  if (playerRoll == dealerRoll) {
...
void DEFINED_LOCATION_Street(){
    ...
    int USER_CHOICE_INPUT_kBOqjyCd = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_kBOqjyCd == 1){

DEFINED_LOCATION_Forrest();
  }

  if (USER_CHOICE_INPUT_kBOqjyCd == 2){

DEFINED_LOCATION_Bar();
  }

  if (USER_CHOICE_INPUT_kBOqjyCd == 3){

DEFINED_LOCATION_Shop();
  }

  if (USER_CHOICE_INPUT_kBOqjyCd == 4){
...
void DEFINED_LOCATION_Shop(){
  if (PLAYER_STRUCT.VisitedShop == false) {
    ...
    int USER_CHOICE_INPUT_71n4Tmu6 = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_71n4Tmu6 == 1){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_71n4Tmu6 == 2){
  if (PLAYER_STRUCT.Gold >= 10) {
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_71n4Tmu6 == 3){
...
void DEFINED_LOCATION_Forrest(){
  if (PLAYER_STRUCT.VisitedForrest == false) {
    ...
    int USER_CHOICE_INPUT_AkeCIJNi = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_AkeCIJNi == 1){

DEFINED_LOCATION_Field();
  }

  if (USER_CHOICE_INPUT_AkeCIJNi == 2){

DEFINED_LOCATION_Old_Castle();
  }

  if (USER_CHOICE_INPUT_AkeCIJNi == 3){
...
void DEFINED_LOCATION_Field(){
    ...
    int USER_CHOICE_INPUT_UatAlDe = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_UatAlDe == 1){
    ...
    int USER_CHOICE_INPUT_D80ZEeo = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_D80ZEeo == 1){
  ...
  if (USER_CHOICE_INPUT_D80ZEeo == 2){
  ...
  if (bad == true) {
    ...
    int USER_CHOICE_INPUT_CCgxU6Mu = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_CCgxU6Mu == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_CCgxU6Mu == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_CCgxU6Mu == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_UatAlDe == 2){
    ...
    int USER_CHOICE_INPUT_CX2fIcY2 = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_CX2fIcY2 == 1){
...
DEFINED_LOCATION_House();
  ...
  if (USER_CHOICE_INPUT_CX2fIcY2 == 2){
...
DEFINED_LOCATION_Street();
  ...
  if (USER_CHOICE_INPUT_CX2fIcY2 == 3){
...
DEFINED_LOCATION_WitchFight();
    ...
    int USER_CHOICE_INPUT_c3aeoa3S = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_c3aeoa3S == 1){
    ...
    int USER_CHOICE_INPUT_iKY9epeV = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_iKY9epeV == 1){
...
DEFINED_LOCATION_Basement();
  ...
  if (USER_CHOICE_INPUT_iKY9epeV == 2){
...
DEFINED_LOCATION_Field();
  ...
  if (USER_CHOICE_INPUT_c3aeoa3S == 2){
...
void DEFINED_LOCATION_WitchFight(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_GE3ruDq = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_GE3ruDq == 1){
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_GE3ruDq == 2){
 ...
 } else if (USER_CHOICE_INPUT_GE3ruDq == 2) { USER_CHOICE_INPUT_GE3ruDq = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_GE3ruDq == 3){
 ...
 } else if (USER_CHOICE_INPUT_GE3ruDq == 3) { USER_CHOICE_INPUT_GE3ruDq = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_GE3ruDq == 4){
 ...
 } else if (USER_CHOICE_INPUT_GE3ruDq == 4) { USER_CHOICE_INPUT_GE3ruDq = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_GE3ruDq == 5){
 ...
 } else if (USER_CHOICE_INPUT_GE3ruDq == 5) { USER_CHOICE_INPUT_GE3ruDq = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_GE3ruDq == 6){
 ...
 } else if (USER_CHOICE_INPUT_GE3ruDq == 6) { USER_CHOICE_INPUT_GE3ruDq = 7; } 
...
DEFINED_LOCATION_House();
  ...
  if (witch_HP < 50 && Random_Int_Num(1, 2) == 1) {
    ...
    int USER_CHOICE_INPUT_Bps7cRE2 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_Bps7cRE2 == 1){
  ...
  if (USER_CHOICE_INPUT_Bps7cRE2 == 2){
  ...
  if (Random_Int_Num(1, 15) == 1) printf("\n5. Smack that booty"); 
    ...
    int USER_CHOICE_INPUT_jF0nS7qo = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_jF0nS7qo == 1){
 ...
 if (Random_Int_Num(1, 3) == 1){
  ...
  if (USER_CHOICE_INPUT_jF0nS7qo == 2){
 ...
 } else if (USER_CHOICE_INPUT_jF0nS7qo == 2) { USER_CHOICE_INPUT_jF0nS7qo = 3; } 

 if (Random_Int_Num(1, 3) == 1){

  if (USER_CHOICE_INPUT_jF0nS7qo == 3){
 ...
 } else if (USER_CHOICE_INPUT_jF0nS7qo == 3) { USER_CHOICE_INPUT_jF0nS7qo = 4; } 

 if (Random_Int_Num(1, 4) == 1){

  if (USER_CHOICE_INPUT_jF0nS7qo == 4){
 ...
 } else if (USER_CHOICE_INPUT_jF0nS7qo == 4) { USER_CHOICE_INPUT_jF0nS7qo = 5; } 

 if (Random_Int_Num(1, 15) == 1){

  if (USER_CHOICE_INPUT_jF0nS7qo == 5){
 ...
 } else if (USER_CHOICE_INPUT_jF0nS7qo == 5) { USER_CHOICE_INPUT_jF0nS7qo = 6; } 
...
void DEFINED_LOCATION_Old_Castle(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_sGFVI4g0 = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_sGFVI4g0 == 1){
  ...
  if (USER_CHOICE_INPUT_sGFVI4g0 == 2){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_htUIdZA = COMPILER_TOOL_GET_INPUT(4);

  if (USER_CHOICE_INPUT_htUIdZA == 1){

DEFINED_LOCATION_Bed_Room();
  }

  if (USER_CHOICE_INPUT_htUIdZA == 2){
  ...
  if (USER_CHOICE_INPUT_htUIdZA == 3){
...
DEFINED_LOCATION_Forrest();
  ...
  if (USER_CHOICE_INPUT_htUIdZA == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_sGFVI4g0 == 3){
    ...
    int USER_CHOICE_INPUT_kUwpK6x = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_kUwpK6x == 1){
    ...
    int USER_CHOICE_INPUT_4ZHJZ7Hr = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_4ZHJZ7Hr == 1){
...
DEFINED_LOCATION_FightTheDragon();
  ...
  if (USER_CHOICE_INPUT_4ZHJZ7Hr == 2){
  ...
  if (USER_CHOICE_INPUT_kUwpK6x == 2){
...
void DEFINED_LOCATION_Bed_Room(){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_MU9whBYC = COMPILER_TOOL_GET_INPUT(5);

  if (USER_CHOICE_INPUT_MU9whBYC == 1){
  ...
  if (USER_CHOICE_INPUT_MU9whBYC == 2){
    ...
    int USER_CHOICE_INPUT_Dlmc41RM = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_Dlmc41RM == 1){
  ...
  while(Answer) {
    ...
    int USER_CHOICE_INPUT_GJSIrzJ = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_GJSIrzJ == 1){
  ...
  if (USER_CHOICE_INPUT_GJSIrzJ == 2){

DEFINED_LOCATION_Dining_Room();
  }

  if (USER_CHOICE_INPUT_GJSIrzJ == 3){
...
DEFINED_LOCATION_Old_Castle();
  ...
  if (USER_CHOICE_INPUT_Dlmc41RM == 2){
  ...
  if (USER_CHOICE_INPUT_MU9whBYC == 3){
  ...
  if (USER_CHOICE_INPUT_MU9whBYC == 4){
...
DEFINED_LOCATION_Dining_Room();
  ...
  if (USER_CHOICE_INPUT_MU9whBYC == 5){
...
void DEFINED_LOCATION_FightTheDragon(){
  ...
  if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true) printf("\n6. Attack with the Great old Sword!"); 
    ...
    int USER_CHOICE_INPUT_oqXIBub6 = COMPILER_TOOL_GET_INPUT(6);

  if (USER_CHOICE_INPUT_oqXIBub6 == 1){
    roll=Random_Int_Num(3, 8);
 ...
 if (PLAYER_STRUCT.regular_sword){
  ...
  if (USER_CHOICE_INPUT_oqXIBub6 == 2){
    roll=Random_Int_Num(PLAYER_STRUCT.regular_sword_damage-3, PLAYER_STRUCT.regular_sword_damage+3);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_oqXIBub6 == 2) { USER_CHOICE_INPUT_oqXIBub6 = 3; } 

 if (PLAYER_STRUCT.potion_amount > 0){

  if (USER_CHOICE_INPUT_oqXIBub6 == 3){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.potion_health;
 ...
 } else if (USER_CHOICE_INPUT_oqXIBub6 == 3) { USER_CHOICE_INPUT_oqXIBub6 = 4; } 

 if (PLAYER_STRUCT.bandage_amount > 0){

  if (USER_CHOICE_INPUT_oqXIBub6 == 4){
    PLAYER_STRUCT.Health_point+=PLAYER_STRUCT.bandage_health;
 ...
 } else if (USER_CHOICE_INPUT_oqXIBub6 == 4) { USER_CHOICE_INPUT_oqXIBub6 = 5; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == false){

  if (USER_CHOICE_INPUT_oqXIBub6 == 5){
 ...
 } else if (USER_CHOICE_INPUT_oqXIBub6 == 5) { USER_CHOICE_INPUT_oqXIBub6 = 6; } 

 if (PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE && PLAYER_STRUCT.GreatSwordReady == true){

  if (USER_CHOICE_INPUT_oqXIBub6 == 6){
    roll=Random_Int_Num(PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE-13, PLAYER_STRUCT.THE_GREAT_SWORD_OF_THE_OLD_ONE_DAMAGE+13);
    The_dragon_of_smaguron_health-=roll;
 ...
 } else if (USER_CHOICE_INPUT_oqXIBub6 == 6) { USER_CHOICE_INPUT_oqXIBub6 = 7; } 
...
DEFINED_LOCATION_TheEnd();
  ...
  if (The_dragon_of_smaguron_health < 400 && Random_Int_Num(1, 3) == 3) {
    ...
    int USER_CHOICE_INPUT_QzVntto1 = COMPILER_TOOL_GET_INPUT(2);

  if (USER_CHOICE_INPUT_QzVntto1 == 1){
  ...
  if (USER_CHOICE_INPUT_QzVntto1 == 2){
    PLAYER_STRUCT.Health_point+=4;
  }
    ...
    int USER_CHOICE_INPUT_anQVCfK = COMPILER_TOOL_GET_INPUT(3);

  if (USER_CHOICE_INPUT_anQVCfK == 1){
  ...
  if (USER_CHOICE_INPUT_anQVCfK == 2){
  ...
  if (USER_CHOICE_INPUT_anQVCfK == 3){
